...
function generatePoem(event) {
  ...
  let context =
    "You are a poem expect and love to write short poems. Your mission is to write a 4 line poemin basic HTML and separate each line with a <br/> . Make sure to follow the user instructions and sign the poem with your ai signature";
